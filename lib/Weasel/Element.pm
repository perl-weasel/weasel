...
sub find_element_by_class {
    ...
    return $self->session->find_element_by_class($class);
}
...
sub find_element_by_class_name {
    ...
    return $self->session->find_element_by_class_name($class_name);
}
...
sub find_element_by_css {
    ...
    return $self->session->find_element_by_css($css);
}
...
sub find_element_by_id {
    ...
    return $self->session->find_element_by_id($id);
}
...
sub find_element_by_link {
    ...
    return $self->session->find_element_by_link($link);
}
...
sub find_element_by_link_text {
    ...
    return $self->session->find_element_by_link_text($link_text);
}
...
sub find_element_by_name {
    ...
    return $self->session->find_element_by_name($name);
}
...
sub find_element_by_partial_link_text {
    ...
    return $self->session->find_element_by_partial_link_text($partial_link_text);
}
...
sub find_element_by_xpath {
    ...
    return $self->_logged(
        ...
        'find_element_by_xpath', 'element WebElement');
}
=back
